    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-2 md:space-x-4 lg:space-x-8 sm:-my-px sm:ms-10 sm:flex sm:items-center">
                    @auth
                        ...
                        <x-dropdown align="left" width="48">
                            <x-slot name="trigger">
                                <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md
                                            text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-800 hover:text-indigo-600 transition">
                                    <span>{{ __('Admin') }}</span>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('templates.index')" :active="request()->routeIs('templates.*')">
                                    {{ __('Manage Services') }}
                                </x-dropdown-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 font-medium hover:text-indigo-600 transition">
                        Log in
                    </a>
                    <a href="{{ route('register') }}" class="bg-indigo-600 text-white px-2 py-1 rounded-lg font-semibold hover:bg-indigo-700 transition">
                        Get Started
                    </a>
                </div>
                @endauth
